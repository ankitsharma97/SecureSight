...
async function main() {
  ...
  const incidents = [
    // Yesterday incidents
    {
      ...
      tsEnd: new Date(yesterday.getTime() + 8 * 60 * 60 * 1000 + 2 * 60 * 1000), // 8:02 AM
    ...
    },
    {
      ...
      type: "Gun Threat",
      tsStart: new Date(yesterday.getTime() + 10 * 60 * 60 * 1000), // 10 AM
      tsEnd: new Date(yesterday.getTime() + 10 * 60 * 60 * 1000 + 3 * 60 * 1000), // 10:03 AM
    ...
    },
    {
      ...
      tsStart: new Date(yesterday.getTime() + 6 * 60 * 60 * 1000), // 6 AM
      tsEnd: new Date(yesterday.getTime() + 6 * 60 * 60 * 1000 + 1 * 60 * 1000), // 6:01 AM
    ...
    },
    {
      ...
      tsEnd: new Date(yesterday.getTime() + 14 * 60 * 60 * 1000 + 2 * 60 * 1000), // 2:02 PM
    ...
    },
    {
      ...
      tsEnd: new Date(yesterday.getTime() + 16 * 60 * 60 * 1000 + 4 * 60 * 1000), // 4:04 PM
    ...
    },
    {
      ...
      tsEnd: new Date(yesterday.getTime() + 18 * 60 * 60 * 1000 + 2 * 60 * 1000), // 6:02 PM
    ...
    },
    {
      ...
      tsEnd: new Date(yesterday.getTime() + 20 * 60 * 60 * 1000 + 1 * 60 * 1000), // 8:01 PM
    ...
    },
    {
      ...
      tsEnd: new Date(yesterday.getTime() + 22 * 60 * 60 * 1000 + 3 * 60 * 1000), // 10:03 PM
    ...
    },
    {
      cameraId: cameras[1].id,
      type: "Face Recognised",
      tsStart: new Date(now.getTime() - 10 * 60 * 1000), // 10 minutes ago
